...
char* filenameRugged = "./resource/texture_rugged_metal.bmp"; //image file with texture
char* filenameRusted = "./resource/texture_rusted_metal.bmp"; //image file with texture
char* filenameGolden = "./resource/texture_golden_metal.bmp"; //image file with texture
char* filenameGlass = "./resource/texture_glass.bmp"; //image file with texture
